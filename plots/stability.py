...
results = json.load(open('gendata_1/stability/purity_results.json','r'))
projs = pd.read_table('gendata_1/elpi/branches.tsv',index_col=0)
embeds_path = Path('gendata_1/model/embeddings.tsv')
graph_dir = Path('gendata_1/elpi')

out_plots_folder = Path('gendata_1/plots/stability')
